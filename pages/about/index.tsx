      ...
      <div className="mx-auto my-auto flex">
        <div className="mx-auto flex flex-col">
          <div className="max-w-[1400px] p-6 text-black flex flex-col md:flex-row mx-auto md:space-x-5 place-content-between">
            ...
            <div className="relative place-content-center flex md:w-[500px] w-full mx-auto my-auto md:my-auto mb-5">
              <Image
      ...
      <div className="mx-auto my-auto flex">
        <div className="mx-auto flex flex-col">
          <div className="max-w-[1400px] p-6 text-black flex flex-col md:flex-row mx-auto md:space-x-10 place-content-between">
            ...
            <div className="relative place-content-center flex md:w-[600px] w-full mx-auto my-auto md:my-auto mb-5">
              <Image
